...
namespace ScreeningExchange.Infrastructure.Migrations
{
    ...
    [Migration("20241230154915_add-ownsmany-log")]
    partial class addownsmanylog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScreeningExchange.Domain.Aggregates.LinkDispatchersAggregate.LinkDispatcher", b =>
                {
                    ...
                    b.OwnsMany("ScreeningExchange.Domain.Aggregates.LinkDispatchersAggregate.Log", "Logs", b1 =>
                        {
